...
public class ShabadArtActivity extends AppCompatActivity {
    ...
    ImageButton quoteBackBtn, screenshotBtn, settingsBtn, closeSettingsViewBtn, resetSettingsViewBtn, closeColorPickerViewBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTheme(mode);
        setContentView(R.layout.activity_shabad_art);
        ...
        cursor = database.rawQuery("SELECT * FROM Shabad_ID WHERE SHABAD_ID = ? AND SOURCE_ID = ?", new String[]{quoteShabadID, quoteSource});
        ...
        if (cursor.getString(8).equals("SGGS")) {
            LineTxt = "Shabad : " + cursor.getInt(3) + ", Ang : " + cursor.getInt(1);
        } else LineTxt = "Shabad : " + cursor.getInt(3);
        ...
        screenshotBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (ContextCompat.checkSelfPermission(ShabadArtActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
                    if (ActivityCompat.shouldShowRequestPermissionRationale(ShabadArtActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
                        new AlertDialog.Builder(ShabadArtActivity.this).setTitle("Permission Needed").setMessage("This permission is needed to save Quote as an Image in your External Storage before Sharing").setPositiveButton("Okay", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ActivityCompat.requestPermissions(ShabadArtActivity.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, MY_PERMISSIONS_REQUEST_WRITE_STORAGE);
                            }
                        ...
                        ActivityCompat.requestPermissions(ShabadArtActivity.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, MY_PERMISSIONS_REQUEST_WRITE_STORAGE);
                        Toast.makeText(ShabadArtActivity.this, "External Storage access is required", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    ...
                    if(isExternalStorageWritable()){
                        ...
                        //String mPath = Environment.getExternalStorageDirectory().toString() + "/GranthSahibShares/" +"GranthSahib_Shabad_ID_" + quoteLineID + ".jpg";
                        String mPath = getExternalFilesDir(null) + "/GranthSahibShares/" +"GranthSahib_Shabad_ID_" + quoteLineID + ".jpg";
                        ...
                        try {
                            ...
                            if(outputStream!=null){
                                ...
                                contentUri = getUriForFile(ShabadArtActivity.this, "com.randoms.granthsahib.fileprovider", imageFile);
                                intentShare.putExtra(Intent.EXTRA_STREAM, contentUri);
                                startActivity(Intent.createChooser(intentShare, "Share as Shabad"));
                                try {
                                    outputStream.flush();
                                } catch (IOException e) {
                                    e.printStackTrace();
                    ...
                    else Toast.makeText(ShabadArtActivity.this, "External Storage is not writable at the moment, please try again later", Toast.LENGTH_LONG).show();
                }
            }
        });
    ...
    void setDefaultSettings(){
        ...
        gurmukhiSizeSeekBar.setProgress(17);
        gurmukhiSeekBarProgress.setText("17");

        englishSizeSeekBar.setMax(48);
        englishSizeSeekBar.setProgress(11);
        englishSeekBarProgress.setText("11");

        punjabiSizeSeekBar.setMax(48);
        punjabiSizeSeekBar.setProgress(13);
        punjabiSeekBarProgress.setText("13");
